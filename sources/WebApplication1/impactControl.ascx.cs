...
{
    public partial class impactControl : System.Web.UI.UserControl
    {
        ...
        protected void SqlDataSource1_Inserted(object sender, SqlDataSourceStatusEventArgs e)
        {
            ...
            if (Session != null && (String.IsNullOrEmpty(TechnologyId) || String.IsNullOrEmpty(ContextId)))
            {
                TechnologyId = Session["tech"].ToString();
                ContextId = Session["context"].ToString();
            }
            ...
            //Label lbl = mstr.FindControl("selectedImpact") as Label;
            //lbl.Text = "Helol";
        }
