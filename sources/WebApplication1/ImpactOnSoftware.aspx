<%@ Page Title="Impact Details" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="ImpactOnSoftware.aspx.cs" Inherits="WebApplication1.ImpactOnSoftware" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_area item3">
        ...
        <div id="form_together">
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource1" Style="margin-right: 104px" CssClass="stylesheets/layout.css" AllowPaging="True" DefaultMode="ReadOnly" OnModeChanged="FormView_ModeChanged" Width="750px">
                <EditItemTemplate>
                        ...
                        <table class="table_form">
                            <tr>
                                ...
                                <td class="col2">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ControlToValidate="ISO25010TextBox" ErrorMessage="Please select atleast one!" runat="server" Font-Italic="true" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                         <asp:SqlDataSource ID="ISO25010" runat="server" ConnectionString="<%$ ConnectionStrings:PCF_CONNECTION %>" ProviderName="<%$ ConnectionStrings:PCF_CONNECTION.ProviderName %>" SelectCommand="SELECT [QA_Characteristic], [ID] FROM [ISO25010]"></asp:SqlDataSource>
                    ...
                    <div class="form_domain">
                        <table class="table_form">
                            <tr>
                                ...
                                <td class="col1" >
                                    <label class="label">
                                        <asp:Button ID="Button1" runat="server" CausesValidation="True" CommandName="Insert" Text="Save Impact" class="button gray" OnClick="Button1_Click" /></label></td>
                                <td class="col2" >
                                    <asp:Button ID="InsertCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" class="button gray" />
...
WHERE        (TCI.Impact = @impactID)">
                               ...
                               <%-- <% String co = "";
                                   co = (String)Request.QueryString["c"];
                                ...
                                <%}
                                   ...
                                   { %>
                                <td class="col1">
                                    <label class="label">Insert Existing Context:</label></td>
                                <td class="col2">
                                    <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="InsertExistingContext" DataTextField="Name" DataValueField="ID">
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="InsertExistingContext" runat="server" ConnectionString="<%$ ConnectionStrings:PCF_CONNECTION %>" ProviderName="<%$ ConnectionStrings:PCF_CONNECTION.ProviderName %>" SelectCommand="SELECT Name,[ID] FROM [Contexts]"></asp:SqlDataSource>
                                </td>
                                <%} %>--%>
                            </tr>
                        </table>
                  ...
                  <%--  <div class="form_domain">
                        <table class="table_form">
                            <tr>
                                ...
                                <td class="col2" >
                                   <label class="label">
                                        <asp:Button ID="Button11" runat="server" CausesValidation="True" CommandName="Edit" Text="Edit" CssClass="button gray"  Width="100px" /></label>
                               </td>
                            </tr>
                        </table>
                    </div>--%>
                    ...
                    <%--<div class="form_domain">
                        <table class="table_form">
                            <tr>
                                ...
                                <td class="col2" >
                                   <label class="label">
                                        <asp:Button ID="NewButton" runat="server" CausesValidation="False" CommandName="New" Text="Insert New Impact" class="button gray" /></label>
                               </td>
                            </tr>
                        </table>
                    </div>--%>
