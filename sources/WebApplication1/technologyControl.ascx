<%@ Control Language="C#" AutoEventWireup="true" CodeFile="technologyControl.ascx.cs" Inherits="WebApplication1.technologyControl" %>



<asp:Panel ID ="mainP" runat="server">
<div class="form_area_new">
        ...
        <div id="form_together">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PCF_CONNECTION %>" InsertCommand="INSERT INTO Technologies(Name, Abbreviation, Objectives, Author, Complements, Alternatives, Literature, Background, Qualification, Training, Experience, Input_Artifact, Output_Artifact, Applied_By_Role, Shoert_Description, SPEM_Model, SE_Phase, Method, Family,
                        Input_AL_COMPONENT, Input_AL_CHIP, Input_AL_BOARD, Input_AL_IP, Input_AL_OTHER, Input_VP_REQUIREMENT, Input_VP_FUNCTIONAL, Input_VP_TECHNICAL, 
                         Input_VP_LOGICAL, Input_VP_OTHER, Output_AL_COMPONENT, Output_AL_CHIP, Output_AL_BOARD, Output_AL_IP, Output_AL_OTHER, Output_VP_REQUIREMENT, 
                         Output_VP_FUNCTIONAL, Output_VP_TECHNICAL, Output_VP_LOGICAL, Output_VP_OTHER, TECH_AL_COMPONENT, TECH_AL_CHIP, TECH_AL_BOARD, 
                         TECH_AL_IP, TECH_AL_OTHER, TECH_VP_REQUIREMENT, TECH_VP_FUNCTIONAL, TECH_VP_TECHNICAL, TECH_VP_LOGICAL, TECH_VP_OTHER) VALUES 
                        ...
                        @Input_AL_COMPONENT, @Input_AL_CHIP, @Input_AL_BOARD, @Input_AL_IP, @Input_AL_OTHER, @Input_VP_REQUIREMENT, @Input_VP_FUNCTIONAL, @Input_VP_TECHNICAL, 
                         @Input_VP_LOGICAL, @Input_VP_OTHER, @Output_AL_COMPONENT, @Output_AL_CHIP, @Output_AL_BOARD, @Output_AL_IP, @Output_AL_OTHER, @Output_VP_REQUIREMENT, 
                         @Output_VP_FUNCTIONAL, @Output_VP_TECHNICAL, @Output_VP_LOGICAL, @Output_VP_OTHER, @TECH_AL_COMPONENT, @TECH_AL_CHIP, @TECH_AL_BOARD, 
                         @TECH_AL_IP, @TECH_AL_OTHER, @TECH_VP_REQUIREMENT, @TECH_VP_FUNCTIONAL, @TECH_VP_TECHNICAL, @TECH_VP_LOGICAL, @TECH_VP_OTHER)"
                ProviderName="<%$ ConnectionStrings:PCF_CONNECTION.ProviderName %>" SelectCommand="SELECT        Technologies.Name as Name, Abbreviation, Objectives,Author, Author.Name as AuthorName, Complements, Alternatives, Literature, Background, Qualification, Training, Experience, Input_Artifact, Output_Artifact, 
                         Applied_By_Role, Shoert_Description, SPEM_Model, SEphase.Name as SE_PhaseName, TechnologyId, Method, Family, Input_AL_COMPONENT, Input_AL_CHIP, Input_AL_BOARD, 
                         ...
                         TECH_VP_REQUIREMENT, TECH_VP_FUNCTIONAL, TECH_VP_TECHNICAL, TECH_VP_LOGICAL, TECH_VP_OTHER FROM Technologies,SEphase,Author where Technologies.SE_Phase=SEphase.ID and Technologies.Author=Author.ID order by Technologies.TechnologyId desc"
                ...
                UpdateCommand="UPDATE Technologies SET Name =@Name, Abbreviation =@Abbreviation, Objectives =@Objectives, Author =@Author, Literature =@Literature, Background =@Background, Qualification =@Qualification, Training =@Training, Experience =@Experience, Input_Artifact =@Input_Artifact, 
                         Output_Artifact =@Output_Artifact, Applied_By_Role =@Applied_By_Role, Shoert_Description =@Shoert_Description, SPEM_Model =@SPEM_Model, SE_Phase =@SE_Phase,  Family =@Family, Input_AL_COMPONENT =@Input_AL_COMPONENT, Input_AL_CHIP =@Input_AL_CHIP, 
                         Input_AL_BOARD =@Input_AL_BOARD, Input_AL_IP =@Input_AL_IP, Input_AL_OTHER =@Input_AL_OTHER, Input_VP_REQUIREMENT =@Input_VP_REQUIREMENT, Input_VP_FUNCTIONAL =@Input_VP_FUNCTIONAL, Input_VP_TECHNICAL =@Input_VP_TECHNICAL, Input_VP_LOGICAL =@Input_VP_LOGICAL, 
                         Input_VP_OTHER =@Input_VP_OTHER, Output_AL_COMPONENT =@Output_AL_COMPONENT, Output_AL_CHIP =@Output_AL_CHIP, Output_AL_BOARD =@Output_AL_BOARD, Output_AL_IP =@Output_AL_IP, Output_AL_OTHER =@Output_AL_OTHER, Output_VP_REQUIREMENT =@Output_VP_REQUIREMENT, 
                         Output_VP_FUNCTIONAL =@Output_VP_FUNCTIONAL, Output_VP_TECHNICAL =@Output_VP_TECHNICAL, Output_VP_LOGICAL =@Output_VP_LOGICAL, Output_VP_OTHER =@Output_VP_OTHER, TECH_AL_COMPONENT =@TECH_AL_COMPONENT, TECH_AL_CHIP =@TECH_AL_CHIP, TECH_AL_BOARD =@TECH_AL_BOARD, 
                         TECH_AL_IP =@TECH_AL_IP, TECH_AL_OTHER =@TECH_AL_OTHER, TECH_VP_REQUIREMENT =@TECH_VP_REQUIREMENT, TECH_VP_FUNCTIONAL =@TECH_VP_FUNCTIONAL, TECH_VP_TECHNICAL =@TECH_VP_TECHNICAL, TECH_VP_LOGICAL =@TECH_VP_LOGICAL, TECH_VP_OTHER =@TECH_VP_OTHER where TechnologyId=@TechnologyId">
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="Input_AL_COMPONENT" />
                    <asp:Parameter Name="Input_AL_CHIP" />
                    <asp:Parameter Name="Input_AL_BOARD" />
                    <asp:Parameter Name="Input_AL_IP" />
                    <asp:Parameter Name="Input_AL_OTHER" />
                    <asp:Parameter Name="Input_VP_REQUIREMENT" />
                    <asp:Parameter Name="Input_VP_FUNCTIONAL" />
                    <asp:Parameter Name="Input_VP_TECHNICAL" />
                    <asp:Parameter Name="Input_VP_LOGICAL" />
                    <asp:Parameter Name="Input_VP_OTHER" />
                    <asp:Parameter Name="Output_AL_COMPONENT" />
                    <asp:Parameter Name="Output_AL_CHIP" />
                    <asp:Parameter Name="Output_AL_BOARD" />
                    <asp:Parameter Name="Output_AL_IP" />
                    <asp:Parameter Name="Output_AL_OTHER" />
                    <asp:Parameter Name="Output_VP_REQUIREMENT" />
                    <asp:Parameter Name="Output_VP_FUNCTIONAL" />
                    <asp:Parameter Name="Output_VP_TECHNICAL" />
                    <asp:Parameter Name="Output_VP_LOGICAL" />
                    <asp:Parameter Name="Output_VP_OTHER" />
                    <asp:Parameter Name="TECH_AL_COMPONENT" />
                    <asp:Parameter Name="TECH_AL_CHIP" />
                    <asp:Parameter Name="TECH_AL_BOARD" />
                    <asp:Parameter Name="TECH_AL_IP" />
                    <asp:Parameter Name="TECH_AL_OTHER" />
                    <asp:Parameter Name="TECH_VP_REQUIREMENT" />
                    <asp:Parameter Name="TECH_VP_FUNCTIONAL" />
                    <asp:Parameter Name="TECH_VP_TECHNICAL" />
                    <asp:Parameter Name="TECH_VP_LOGICAL" />
                    <asp:Parameter Name="TECH_VP_OTHER" />
            ...
            <asp:FormView ID="FormView1" runat="server" AllowPaging="false" DataSourceID="SqlDataSource1" OnItemInserting="FormView1_ItemInserting" OnModeChanged="FormView_ModeChanged" Style="margin-left: 0px; margin-right: 10px;" Width="750px">
                <EditItemTemplate>
                            ...
                            <tr>
                                ...
                                <td class="col1" colspan="2">
                                    <table class="table_form" border="1" style="border-color: #CCCCCC; border-width: 1px; border-style: Solid; border-collapse: collapse; text-align: center; vertical-align: top">
                                        <tr>
                                            <td colspan="1"></td>
                                            <td colspan="5" class="col0">Abstraction Level
                                            </td>
                                            <td colspan="5" class="col0">Perspective Level
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="1">&nbsp;</td>
                                            <td>
                                                <img src="imgs/icons/computer30p.png" alt="COMPUTER" title="COMPUTER" /></td>
                                            <td>
                                                <img src="imgs/icons/chip30p.png" alt="CHIP" title="CHIP" /></td>
                                            <td>
                                                <img src="imgs/icons/board30p.png" alt="BOARD" title="BOARD" /></td>
                                            <td>
                                                <img src="imgs/icons/ip30p.png" alt="IP" title="IP" /></td>
                                            <td>
                                                <img src="imgs/icons/Other30.png" alt="OTHER" title="OTHER" /></td>
                                            <td>
                                                <img src="imgs/icons/operational30p.png" alt="OPERATIONAL" title="OPERATIONAL" /></td>
                                            <td>
                                                <img src="imgs/icons/Funcional30p.png" alt="FUNCTIONAL" title="FUNCTIONAL" /></td>
                                            <td>
                                                <img src="imgs/icons/logical30p.png" alt="LOGICAL" title="LOGICAL" /></td>
                                            <td>
                                                <img src="imgs/icons/Technical30p.png" alt="TECHNICAL" title="TECHNICAL" /></td>
                                            <td>
                                                <img src="imgs/icons/Other30.png" alt="OTHER" title="OTHER" /></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label27" CssClass="label" ForeColor="Red" runat="server" Text="*"/>
 ...
 runat="server" Font-Italic="true" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="Input_AL_COMPONENT" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_COMPONENT")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_CHIP" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_CHIP")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_BOARD" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_BOARD")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_IP" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_IP")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_OTHER" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_OTHER")) %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="Input_VP_REQUIREMENT" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_REQUIREMENT")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_VP_FUNCTIONAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_FUNCTIONAL")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_VP_LOGICAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_LOGICAL")) %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="Input_VP_TECHNICAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_TECHNICAL")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_VP_OTHER" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_OTHER")) %>' /></td>
                                        </tr>

                                        <tr>
                                            <td><asp:Label ID="Label26" CssClass="label" ForeColor="Red" runat="server" Text="*"/>
 ...
 runat="server" Font-Italic="true" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="Output_AL_COMPONENT" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_COMPONENT")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_CHIP" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_CHIP")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_BOARD" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_BOARD")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_IP" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_IP")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_OTHER" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_OTHER")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_REQUIREMENT" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_REQUIREMENT")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_FUNCTIONAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_FUNCTIONAL")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_LOGICAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_LOGICAL")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_TECHNICAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_TECHNICAL")) %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_OTHER" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_OTHER")) %>' />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Applies In/By :</td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_COMPONENT" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_COMPONENT")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_CHIP" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_CHIP")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_BOARD" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_BOARD")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_IP" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_IP")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_OTHER" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_OTHER")) %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="TECH_VP_REQUIREMENT" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_REQUIREMENT")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_VP_FUNCTIONAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_FUNCTIONAL")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_VP_LOGICAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_LOGICAL")) %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="TECH_VP_TECHNICAL" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_TECHNICAL")) %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_VP_OTHER" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_OTHER")) %>' /></td>
           ...
           //txt.visible = true;
                ...
                <InsertItemTemplate>
                    ...
                    <div class="form_domain">
                        ...
                        <table class="table_form">
                            <tr>
                                <td rowspan="2" class="col0" style="vertical-align: middle;">
                                    <img src="imgs/apllied_in_by.png" alt="applied in/by" width="19" height="110" />
                                </td>
                                <td colspan="2" class="col1">
                                    <table class="table_form" border="1" style="border-color: #CCCCCC; border-width: 1px; border-style: Solid; border-collapse: collapse; text-align: center; vertical-align: top">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label20" CssClass="label" ForeColor="Red" runat="server" Text="*"/>
                                                 <asp:Label ID="Label29" CssClass="label" runat="server" Text="Input:"></asp:Label>&nbsp;
                                        ...
                                        runat="server" Font-Italic="true" Display="Dynamic" ForeColor="Red" validationgroup="insertOnly"></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="Input_AL_COMPONENT" runat="server" Checked='<%# Bind("Input_AL_COMPONENT") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_CHIP" runat="server" Checked='<%# Bind("Input_AL_CHIP") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_BOARD" runat="server" Checked='<%# Bind("Input_AL_BOARD") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_IP" runat="server" Checked='<%# Bind("Input_AL_IP") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_AL_OTHER" runat="server" Checked='<%# Bind("Input_AL_OTHER") %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="Input_VP_REQUIREMENT" runat="server" Checked='<%# Bind("Input_VP_REQUIREMENT") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_VP_FUNCTIONAL" runat="server" Checked='<%# Bind("Input_VP_FUNCTIONAL") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_VP_LOGICAL" runat="server" Checked='<%# Bind("Input_VP_LOGICAL") %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="Input_VP_TECHNICAL" runat="server" Checked='<%# Bind("Input_VP_TECHNICAL") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="Input_VP_OTHER" runat="server" Checked='<%# Bind("Input_VP_OTHER") %>' /></td>
                                        </tr>

                                        <tr>
                                            <td><asp:Label ID="Label23" CssClass="label" ForeColor="Red" runat="server" Text="*"/>
                                                <asp:Label ID="Label30" runat="server" CssClass="label" Text="Output:"></asp:Label>
                                        ...
                                        runat="server" Font-Italic="true" Display="Dynamic" ForeColor="Red" validationgroup="insertOnly"></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="Output_AL_COMPONENT" runat="server" Checked='<%# Bind("Output_AL_COMPONENT") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_CHIP" runat="server" Checked='<%# Bind("Output_AL_CHIP") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_BOARD" runat="server" Checked='<%# Bind("Output_AL_BOARD") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_IP" runat="server" Checked='<%# Bind("Output_AL_IP") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_AL_OTHER" runat="server" Checked='<%# Bind("Output_AL_OTHER") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_REQUIREMENT" runat="server" Checked='<%# Bind("Output_VP_REQUIREMENT") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_FUNCTIONAL" runat="server" Checked='<%# Bind("Output_VP_FUNCTIONAL") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_LOGICAL" runat="server" Checked='<%# Bind("Output_VP_LOGICAL") %>' />

                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_TECHNICAL" runat="server" Checked='<%# Bind("Output_VP_TECHNICAL") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="Output_VP_OTHER" runat="server" Checked='<%# Bind("Output_VP_OTHER") %>' />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Applies In/By :</td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_COMPONENT" runat="server" Checked='<%# Bind("TECH_AL_COMPONENT") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_CHIP" runat="server" Checked='<%# Bind("TECH_AL_CHIP") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_BOARD" runat="server" Checked='<%# Bind("TECH_AL_BOARD") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_IP" runat="server" Checked='<%# Bind("TECH_AL_IP") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_AL_OTHER" runat="server" Checked='<%# Bind("TECH_AL_OTHER") %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="TECH_VP_REQUIREMENT" runat="server" Checked='<%# Bind("TECH_VP_REQUIREMENT") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_VP_FUNCTIONAL" runat="server" Checked='<%# Bind("TECH_VP_FUNCTIONAL") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_VP_LOGICAL" runat="server" Checked='<%# Bind("TECH_VP_LOGICAL") %>' /></td>

                                            <td>
                                                <asp:CheckBox ID="TECH_VP_TECHNICAL" runat="server" Checked='<%# Bind("TECH_VP_TECHNICAL") %>' /></td>
                                            <td>
                                                <asp:CheckBox ID="TECH_VP_OTHER" runat="server" Checked='<%# Bind("TECH_VP_OTHER") %>' /></td>
                                        </tr>
                                    </table>
                                </td>
                                <td class="col2">&nbsp;
                        ...
                        <table class="table_form">
                            <tr>
                                ...
                                <td class="col1">
                                    ...
                                    <asp:Button ID="InsertButton" runat="server" CausesValidation="True" class="button gray" CommandName="Insert" validationgroup="insertOnly" Height="25px" OnClick="InsertButton_Click" Text="Insert" Width="90px" />

                                </td>
                                <td class="col2">
                                    <asp:Button ID="InsertCancelButton" runat="server" CausesValidation="False" OnClick="InsertCancelButton_Click" CommandName="" Text="Cancel" class="button gray" Height="25px" Width="90px" />
                    ...
                    <div class="form_domain">
                        <table class="table_form">
                            ...
                            <tr>
                                ...
                                <td rowspan="6" class="col0" style="vertical-align: middle;">
                                    <img src="imgs/apllied_in_by.png" alt="applied in/by" width="19" height="110" />
                                </td>
                                <td colspan="1" class="col0">&nbsp;
                                </td>
                                <td colspan="3">
                                    <table class="table_form" border="1" style="border-color: #CCCCCC; border-width: 1px; border-style: Solid; border-collapse: collapse; text-align: center; vertical-align: top">
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label50" CssClass="label" runat="server" Text="Input:"></asp:Label>
                                                <asp:Label ID="Label51" CssClass="textfield" runat="server" Text='<%# Bind("Input_Artifact") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox31" runat="server" Checked='<%#Convert.ToBoolean(Eval("Input_AL_COMPONENT"))%>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox32" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_CHIP")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox33" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_BOARD")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox34" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_IP")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox35" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_AL_OTHER")) %>' Enabled="false" /></td>

                                            <td>
                                                <asp:CheckBox ID="CheckBox36" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_REQUIREMENT")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox37" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_FUNCTIONAL")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox39" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_LOGICAL")) %>' Enabled="false" /></td>

                                            <td>
                                                <asp:CheckBox ID="CheckBox38" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_TECHNICAL")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox40" runat="server" Checked='<%# Convert.ToBoolean(Eval("Input_VP_OTHER")) %>' Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label52" runat="server" CssClass="label" Text="Output:"></asp:Label>
                                                <asp:Label ID="Label53" runat="server" CssClass="textfield" Text='<%# Bind("Output_Artifact") %>' />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox41" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_COMPONENT")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox42" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_CHIP")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox43" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_BOARD") )%>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox44" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_IP")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox45" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_AL_OTHER")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox46" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_REQUIREMENT")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox47" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_FUNCTIONAL")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox49" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_LOGICAL")) %>' Enabled="false" />

                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox48" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_TECHNICAL")) %>' Enabled="false" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox50" runat="server" Checked='<%# Convert.ToBoolean(Eval("Output_VP_OTHER")) %>' Enabled="false" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Applies In/By :</td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox51" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_COMPONENT")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox52" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_CHIP")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox53" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_BOARD")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox54" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_IP")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox55" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_AL_OTHER")) %>' Enabled="false" /></td>

                                            <td>
                                                <asp:CheckBox ID="CheckBox56" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_REQUIREMENT")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox57" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_FUNCTIONAL")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox59" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_LOGICAL")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox58" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_TECHNICAL")) %>' Enabled="false" /></td>
                                            <td>
                                                <asp:CheckBox ID="CheckBox60" runat="server" Checked='<%# Convert.ToBoolean(Eval("TECH_VP_OTHER")) %>' Enabled="false" /></td>
                                    ...
                                    <tr>
                                        <td class="col1">
                                            ...
                                            <asp:FormView ID="FormView3" BorderWidth="1" runat="server" DataKeyNames="ID" DataSourceID="ImpactDetailsByID" Width="750px" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <div class="form_area_ImpactByID ">
                                                    <!--  Impact name box -->
