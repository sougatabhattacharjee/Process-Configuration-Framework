...
{
    public partial class contextControl : System.Web.UI.UserControl
    {
        String TechnologyId = "";
        ...
        protected void SqlDataSource1_Inserted(object sender, SqlDataSourceStatusEventArgs e)
        {
            ...
            if (Session != null)
                TechnologyId1 = Session["tech"].ToString();

            Response.Write("TechnologyId1>>>>" + TechnologyId1);

            DropDownList technologyList = Page.FindControl("technologyList") as DropDownList;
            if (technologyList != null)
                TechnologyId = technologyList.SelectedItem + "";
            // Response.Write("TechnologyId>>>" + technologyList.SelectedIndex);
            // String TechnologyId = "";
            TechnologyId = (String)Request.QueryString["t"];
            // HiddenField contextIdField = FormView1.FindControl("ContextID") as HiddenField;
            ...
            if (technologyList != null)
                ...
                InsertTCI.InsertParameters["Technology"].DefaultValue = TechnologyId1;
            ...
            if ((!String.IsNullOrEmpty(TechnologyId) || !String.IsNullOrEmpty(TechnologyId1)) && !String.IsNullOrEmpty(ContextId.ToString()))
                InsertTCI.Insert();
        }
