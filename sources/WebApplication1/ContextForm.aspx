<%@ Page Title="Context Details" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeFile="ContextForm.aspx.cs" Inherits="WebApplication1.ContextForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <div id="menu">
        <nav>
            <ul class="side_menu">
                <li class="li"><a href="#" class="item"><span class="item_number">1</span>Technology </a></li>
                <p class="explanation">
                    Label<br />
                    Description<br />
                    Prerequisits<br />
                            ...
                            <table class="table_form">
                                <tr>
                                    ...
                                    <td class="col2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="NameTextBox" ErrorMessage="Required!" runat="server" Font-Italic="true" Display="Dynamic" ForeColor="Red" CssClass="label"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="form_domain">
                            <table class="table_form">
                                <tr>
                                    ...
                                    <td class="col2">
                                         <label class="label">
                                            <asp:Button ID="Button1" runat="server" CausesValidation="True" CommandName="Insert" OnClick="Button1_Click" Text="Save" CssClass="button gray"  Width="100px" />
                                        </label>
                                        <label class="label">
